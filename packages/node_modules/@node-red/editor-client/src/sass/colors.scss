...
$header-button-background-active: #e5e7eb;
$header-accent: #ef4444;
$header-menu-color: #374151;
$header-menu-color-disabled: #9ca3af;
$header-menu-heading-color: #1f2937;
$header-menu-sublabel-color: #6b7280;
$header-menu-background: #ffffff;
$header-menu-item-hover: #f3f4f6;
$header-menu-item-border-active: #d1d5db;
$headerMenuItemDivider: #e5e7eb;
$headerMenuCaret: #6b7280;
