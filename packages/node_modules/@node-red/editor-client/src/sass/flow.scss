...
.red-ui-flow-node-button {
    ...
    /* Inject node play button - circular with play icon */
    &[data-node-type="inject"] .red-ui-flow-node-button-button {
        width: 24px;
        height: 24px;
        rx: 12;
        ry: 12;
        fill: #10b981; /* Green for play/inject */
        stroke: #059669;
        stroke-width: 1;
    ...
    /* Debug node eye button - circular with eye icon */
    &[data-node-type="debug"] .red-ui-flow-node-button-button {
        width: 24px;
        height: 24px;
        rx: 12;
        ry: 12;
        fill: #3b82f6; /* Blue for debug */
        stroke: #2563eb;
        stroke-width: 1;
        transition: all 0.2s ease;
...
/* Add icons inside the circular buttons */
...
/* Inject node play icon */
.red-ui-flow-node-button[data-node-type="inject"] .red-ui-flow-node-button-icon {
    font-size: 8px;
    transform: translateX(1px); /* Slight offset for optical centering */
}
