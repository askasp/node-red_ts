...
.nr-ui-view-lasso {
    stroke-width: 2px;
    stroke: var(--red-ui-view-lasso-stroke, #0066cc);
    fill: var(--red-ui-view-lasso-fill, rgba(0, 102, 204, 0.1));
    stroke-dasharray: 5 3;
    opacity: 1;
    pointer-events: none;
}

.red-ui-workspace-lasso-active {
    cursor: crosshair !important;
}

.nr-ui-view-slice {
    stroke-width: 2px;
    stroke: var(--red-ui-view-lasso-stroke, #ff6600);
    fill: none;
...
/* Multi-section card components */
.red-ui-flow-node-shadow {
    fill: var(--theme-card-shadow);
    pointer-events: none;
}

.red-ui-flow-node-header {
    fill: var(--theme-card-bg);
    pointer-events: none;
}

.red-ui-flow-node-header-border {
    stroke: var(--theme-card-border);
    stroke-width: 1;
    pointer-events: none;
}

/* Main node card background using theme variables - exclude badges */
.red-ui-flow-node rect:not(.red-ui-flow-node-badge) {
    fill: var(--theme-card-bg);
    stroke: var(--theme-card-border);
}

/* Ensure node cards use theme colors for main background - exclude badges */
.red-ui-flow-node.red-ui-flow-node-unknown rect:not(.red-ui-flow-node-badge) {
    fill: var(--theme-card-bg);
    stroke: var(--theme-card-border);
}

/* Ensure badges always have their correct colors regardless of theme */
.red-ui-flow-node-badge {
    pointer-events: none;
    /* Badge fill colors are set via JavaScript - don't override them */
}

/* Badge text should always be white */
.red-ui-flow-node text[fill="#ffffff"] {
    fill: #ffffff !important;
    stroke: #ffffff !important;
}

/* Node type text (first row) should adapt to theme */
.red-ui-flow-node-type-text {
    fill: var(--theme-node-text-secondary) !important;
    text-transform: uppercase;
    font-weight: 500;
    letter-spacing: 0.05em;
}

/* Node label text should adapt to theme */
.red-ui-flow-node-label-text {
    fill: var(--theme-node-text) !important;
}

/* Type label styling for modern card design */
.red-ui-flow-node-type-label {
    fill: var(--theme-node-text-secondary) !important;
...
/* Port labels should also adapt to theme */
.red-ui-flow-port-label {
    fill: var(--theme-node-text-secondary) !important;
}

/* All other node text should also adapt to theme (fallback) */
.red-ui-flow-node text:not([fill="#ffffff"]) {
    fill: var(--theme-node-text) !important;
}



.red-ui-flow-node-status-dot {
    pointer-events: none;
}
...
.red-ui-flow-node-button {
    ...
    .red-ui-flow-node-button-background {
        display: none; /* Hide the old background rectangle */
    }
    ...
    /* Inject node small play button */
    &[data-node-type="inject"] .red-ui-flow-node-button-button {
        width: 16px;
        height: 16px;
        rx: 8;
        ry: 8;
        fill: rgba(34, 197, 94, 0.8); /* Subtle green */
        stroke: #22c55e;
        stroke-width: 1;
    ...
    /* Debug node small eye button */
    &[data-node-type="debug"] .red-ui-flow-node-button-button {
        width: 16px;
        height: 16px;
        rx: 8;
        ry: 8;
        fill: rgba(59, 130, 246, 0.8); /* Subtle blue */
        stroke: #3b82f6;
        stroke-width: 1;
        transition: all 0.2s ease;
    ...
    /* Debug node disabled state - closed eye */
    &[data-node-type="debug"].red-ui-flow-node-button-disabled .red-ui-flow-node-button-button {
        fill: rgba(107, 114, 128, 0.6); /* Subtle gray when disabled */
        stroke: #9ca3af;
        opacity: 0.7;
    ...
    /* Hide old button styling for our modern nodes */
    &[data-node-type="inject"], 
    &[data-node-type="debug"] {
        .red-ui-flow-node-button-background {
            display: none;
        }
    }
...
/* Add icons inside the small circular buttons */
.red-ui-flow-node-button-icon {
    pointer-events: none;
    text-anchor: middle;
    dominant-baseline: central;
    font-family: 'Font Awesome 5 Free', 'Font Awesome 5 Pro', 'FontAwesome';
    font-weight: 900;
    font-size: 7px; /* Smaller for the smaller buttons */
    fill: #ffffff; /* Pure white icons */
    stroke: #ffffff; /* Pure white stroke */
    opacity: 1; /* No transparency */
}

/* Inject node small play icon */
.red-ui-flow-node-button[data-node-type="inject"] .red-ui-flow-node-button-icon {
    font-size: 6px;
    fill: #ffffff; /* Pure white */
    stroke: #ffffff; /* Pure white stroke */
}

/* Debug node small eye icon */
.red-ui-flow-node-button[data-node-type="debug"] .red-ui-flow-node-button-icon {
    font-size: 7px;
    fill: #ffffff; /* Pure white */
    stroke: #ffffff; /* Pure white stroke */
}

/* Debug node disabled - show eye-slash icon */
.red-ui-flow-node-button[data-node-type="debug"].red-ui-flow-node-button-disabled .red-ui-flow-node-button-icon {
    /* Will be handled by JavaScript to switch between eye and eye-slash */
}

.red-ui-flow-port {
    stroke: var(--red-ui-link-color) !important;
    stroke-width: 2;
    fill: var(--red-ui-link-color) !important;
    cursor: crosshair;
}
...
#red-ui-workspace:not(.red-ui-workspace-locked) {
    .red-ui-flow-port-hovered {
        stroke: var(--theme-port-hover);
        fill:  var(--theme-port-hover);
    }
}
