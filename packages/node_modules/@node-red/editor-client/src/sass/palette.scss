...
#red-ui-palette {
    position: absolute;
    top: 0;
    left: -180px; /* Hidden off-screen since flow drawer replaces it */
    bottom: 0;
    width: 179px;
    background: var(--theme-palette-bg, var(--red-ui-palette-background));
    border-right: 1px solid var(--theme-palette-border, var(--red-ui-palette-border));
    overflow-y: auto;
    overflow-x: hidden;
    z-index: 2;
...
.red-ui-palette-header {
    ...
    color: var(--theme-palette-text, var(--red-ui-palette-header-color));
    cursor: pointer;
    text-align: left;
    padding: 9px;
    font-weight: bold;
