...
.red-ui-menu-dropdown {
    ...
    // Fix submenu positioning and click areas
    &.red-ui-menu-dropdown-submenus > li.red-ui-menu-dropdown-submenu {
        position: relative;
        ...
        // Also show on focus within for accessibility
        &:focus-within > ul {
            display: block !important;
        }
        
        // Make sure the submenu item text is properly aligned
        > a .red-ui-menu-label {
...
.red-ui-menu-dropdown-submenu {
    ...
    &:hover > .red-ui-menu-dropdown {
        ...
        // Check for right edge overflow and adjust positioning
        @media screen {
            right: auto;
            left: 100%;
        }
    ...
    &.pull-left > .red-ui-menu-dropdown {
        left: -100%;
        right: auto;
        margin-left: 10px;
    }
    
    // Caret indicator (arrow pointing right)
    & > a:after {
        display: block;
        float: right;
        width: 0;
    ...
    & > a {
        position: relative;
        padding-right: 25px !important; // Make room for caret
        cursor: pointer;
        display: block !important;
        width: 100%;
        box-sizing: border-box;
...
ul.red-ui-menu:not(.red-ui-menu-dropdown) {
    ...
    // Submenu arrows and indicators - make them more visible
    &.red-ui-menu-dropdown-submenus > li.red-ui-menu-dropdown-submenu > a:after {
    ...
    &.red-ui-menu-dropdown-submenus.red-ui-menu-dropdown-direction-left > li.red-ui-menu-dropdown-submenu.pull-left > a:after {
    ...
    & > li:hover > a,
    & > li > a:hover,
    & > li.red-ui-menu-dropdown-submenu:hover > a {
        text-decoration: none;
        background-color: var(--red-ui-menuHover, #f5f5f5);
        color: var(--red-ui-menuHoverColor, #333);
    }

    // Disabled state styling
    & > li.disabled > a,
    & > li.disabled > a:hover {
        color: var(--red-ui-menuDisabled, #999);
        background-color: transparent;
        cursor: not-allowed;
    }
