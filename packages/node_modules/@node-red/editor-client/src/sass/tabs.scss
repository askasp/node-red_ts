...
.red-ui-tabs {
    ...
    display:hidden;
    overflow: hidden;
    height: 32px; // Reduced from 35px for leaner look
    ...
    & ul {
        ...
        li {
            ...
            //margin: 2px 1px 0 1px; // Reduced margins for tighter look
            ...
            white-space: nowrap;
            //position: relative;
            //border-radius: 6px 6px 0 0; // Modern rounded corners
            ...
            a.red-ui-tab-label {
                ...
                align-items: center;
                font-size: 12px; // Smaller font for cleaner look
            ...
            &.active {
                ...
                font-weight: bold;
                border-bottom: 2px solid var(--red-ui-primary-text-color); // Modern accent
                z-index: 2;
                //box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15); // Modern shadow
    ...
    &.red-ui-tabs-vertical {
        ...
        & ul {
            padding: 0; // No padding to prevent background bleeding
            height: auto;
            border: none;
            width: 100%;
            ...
            li {
                ...
                // Clean hover effect - very subtle
                &:hover:not(.active) {
                    a.red-ui-tab-label {
                ...
                a.red-ui-tab-label {
                    ...
                    align-items: center;
                    line-height: 1.4;
                    color: #6b7280; // Clean gray like Tailwind
                    text-decoration: none;
                    transition: all 0.15s ease;
                    height: 100%;
                    width: 100%;
                ...
                // Active state - clean blue like Tailwind
                &.active {
                    ...
                    a.red-ui-tab-label {
                        ...
                        i {
                            color: #3b82f6; // Blue icon for active
                        }
                    }
                }
...
// **NEW: Clean horizontal tab styling for edit dialogs/modals**
// Override complex tab styling in edit dialogs to create standard tabs
.red-ui-tray-body .red-ui-tabs,
.red-ui-editor-modal .red-ui-tabs,
.red-ui-dialog .red-ui-tabs {
    height: auto;
    background: transparent;
    border: none;
    overflow: visible;
    ...
    ul {
        ...
        height: auto;
        border: none;
        border-bottom: 1px solid #e5e7eb; // Clean gray border
        background: transparent;
        margin: 0 0 20px 0; // Space below tabs
        overflow: visible;
        ...
        li {
            ...
            a.red-ui-tab-label {
                display: flex;
                align-items: center;
                padding: 12px 20px; // Increased horizontal padding for better balance
                font-size: 14px;
                font-weight: 500;
            ...
            &:hover:not(.active) {
                a.red-ui-tab-label {
                    ...
                    background: #f9fafb; // Very light background on hover
            ...
            // Active state - Tailwind-like styling
            &.active {
                a.red-ui-tab-label {
                    color: #3b82f6; // Blue active color
...
.red-ui-tray-body > div:not(.red-ui-tabs),
.red-ui-editor-modal-body > div:not(.red-ui-tabs),
.red-ui-dialog > div:not(.red-ui-tabs) {
    position: relative;
    z-index: 1;
}

// **NEW: Minimal form improvements - only fix specific alignment issues**
.red-ui-tray-body,
.red-ui-editor-modal-body,
.red-ui-dialog {
    
    // Only fix checkbox alignment without breaking existing layout
    .checkbox,
    .radio {
        // Improve checkbox/radio alignment without flex
        &:not(.inline) {
            display: block;
            margin-bottom: 10px;
...
.red-ui-tab-button {
    ...
    height: 32px;
    background: var(--red-ui-tab-background);
    border-bottom: 0px solid var(--red-ui-primary-border-color);
    z-index: 2;
