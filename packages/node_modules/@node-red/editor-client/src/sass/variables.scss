...
// Heading text
    ...
    // Project-specific palette and sidebar variables (Arc-style theming)
    --red-ui-palette-background: var(--theme-palette-bg);
    --red-ui-palette-border: var(--theme-palette-border);
    --red-ui-sidebar-background: var(--theme-sidebar-bg);
    --red-ui-sidebar-border: var(--theme-sidebar-border);
    --red-ui-workspace-background: var(--theme-canvas-bg);
    ...
    --red-ui-node-selected-color: var(--theme-accent, #{$node-selected-color});
    --red-ui-port-selected-color: var(--theme-accent, #{$port-selected-color});
    ...
    --red-ui-deploy-button-background: var(--theme-accent, #{$deploy-button-background});
    --red-ui-deploy-button-background-hover: var(--theme-accent-hover, #{$deploy-button-background-hover});
    --red-ui-deploy-button-background-active: var(--theme-accent-active, #{$deploy-button-background-active});
