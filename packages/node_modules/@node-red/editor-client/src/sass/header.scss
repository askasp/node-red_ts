...
:root {
    ...
    --theme-menu-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05);
...
ul.red-ui-menu-dropdown {
    ...
    li.red-ui-menu-divider {
        background: var(--theme-menu-border);
        height: 1px;
        margin: 6px 4px;
        border-radius: 0.5px;
    }
