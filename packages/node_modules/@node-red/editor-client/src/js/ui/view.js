...
RED.view = (function() {
    ...
    function init() {
        ...
        chart.on('contextmenu', function(evt) {
            console.log("=== Chart contextmenu event fired ===", evt);
            if (RED.view.DEBUG) {
            ...
            evt.preventDefault()
            evt.stopPropagation()
            console.log("About to call RED.contextMenu.show with:", {
                type: 'workspace',
                x: evt.clientX,
                y: evt.clientY
            });
            ...
            nodeEnter.each(function(d,i) {
                ...
                function createLucideIcon(nodeType, x, y) {
                    ...
                    var lucideIcons = {
                        ...
                        'arrow-up-circle': 'M22 12A10 10 0 1 1 12 2a10 10 0 0 1 10 10z M16 12l-4-4-4 4 M12 16V8',
