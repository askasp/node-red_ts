    ...
    function canvasMouseDown() {
        ...
        if (d3.event.touches || d3.event.button === 0) {
            if (
                ...
                if (!d3.event.altKey && !touchStartTime) {
        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                ...
                if (d._def.button) {
                    ...
                    // Create modern circular button
                    var bgButton;
                    if (d.type === "inject" || d.type === "debug") {
                        // Create circular button for inject and debug nodes
                        ...
                        if (d.type === "inject") {
                            iconText.textContent = "\uf04b"; // FontAwesome play icon
                        } else if (d.type === "debug") {
                            iconText.textContent = "\uf06e"; // FontAwesome eye icon
                        }
