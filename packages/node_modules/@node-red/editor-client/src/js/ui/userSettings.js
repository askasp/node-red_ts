...
RED.userSettings = (function() {
    ...
    function applyInterfaceColor(color) {
        // Project colors are now handled by the project system
        // This function is disabled to prevent conflicts
        console.log('Interface colors disabled - using project colors only');
        return;
    }
    ...
    function init() {
        ...
        RED.userSettings.add({
            ...
            focus: function() {
                setTimeout(function() {
                    $("#red-ui-settings-tab-view").find(".red-ui-form-text-input:first").trigger("focus");
                },200);
            },
            close: function() {
            }
        ...
        // Remove localStorage interface color cleanup - using project colors only
        setTimeout(function() {
            // Clean up old interface color settings to prevent conflicts
            localStorage.removeItem('node-red-interface-color');
            console.log('Old interface color settings removed - using project colors only');
        }, 1000);
    ...
    return {
        ...
        show: show,
        add: addPane,
        applyInterfaceColor: applyInterfaceColor
    };
})();
