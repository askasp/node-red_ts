...
// console.log(globalProjectSettings)
    ...
    this.color = projectSettings.color || '#6b7280'; // Default to gray if no color set
    this.themeMode = projectSettings.themeMode || 'light'; // Default to light mode
...
Project.prototype.update = async function (user, data) {
    ...
    if (data.hasOwnProperty('description') && data.description !== this.description) {
    ...
    if (data.hasOwnProperty('summary') && data.summary !== this.package.description) {
        this.package.description = data.summary;
        savePackage = true;
    }
    if (data.hasOwnProperty('version') && data.version !== this.package.version) {
        this.package.version = data.version;
        savePackage = true;
    }
    
    // Handle project color updates
    if (data.hasOwnProperty('color') && data.color !== this.color) {
        globalProjectSettings.projects[this.name].color = data.color;
        this.color = data.color;
        saveSettings = true;
    }

    // Handle project theme mode updates
    if (data.hasOwnProperty('themeMode') && data.themeMode !== this.themeMode) {
        globalProjectSettings.projects[this.name].themeMode = data.themeMode;
