...
<script type="text/html" data-template-name="switch">
    <style>
        /* Simple form improvements for switch node */
        .form-row {
            margin-bottom: 16px;
        }
        ...
        /* Fix X button clutter in rule container */
        #node-input-rule-container .red-ui-editableList-item-remove {
            position: absolute;
            right: 8px;
            top: 50%;
        ...
        #node-input-rule-container .red-ui-editableList-item-remove:hover {
            background: #fee2e2;
            border-color: #fecaca;
            color: #dc2626;
        }
        
        #node-input-rule-container .red-ui-editableList-item-remove i {
            font-size: 10px;
        }
        
        /* Ensure content doesn't overlap with X button */
        #node-input-rule-container .red-ui-editableList-item-content {
            margin-right: 35px;
        }
        ...
        /* Improve label alignment for checkbox */
        .form-row:last-child {
            display: flex;
            align-items: center;
            gap: 8px;
